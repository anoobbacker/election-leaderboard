...
<div class="bg-white py-12 sm:py-16">
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl lg:text-center">
      <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Kotas Kerala Election Prediction Leaderboard</h2>
			<p class="mt-6 text-lg leading-8 text-gray-600">A fun friendly Kerala Election 2024 prediction leaderboard! 🤞</p>
			<ul role="list" class="pt-6 grid gap-x-8 gap-y-12 sm:grid-cols-2 sm:gap-y-16 xl:col-span-2 place-content-center">
				<li>
  ...
  <div class="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8">
    <div class="relative isolate overflow-hidden bg-gray-900 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
      ...
      <div class="relative mt-16 h-80 lg:mt-8">
        <img class="absolute left-0 top-0 w-[57rem] max-w-none rounded-md bg-white/5 ring-1 ring-white/10" src="/images/screenshots/screen-predict.png" alt="App screenshot" width="1824" height="1080">
      </div>
    </div>
  </div>
</div>
